...
// checks if the V2LeaderboardsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2LeaderboardsGet200Response{}

// V2LeaderboardsGet200Response struct for V2LeaderboardsGet200Response
type V2LeaderboardsGet200Response struct {
...
func NewV2LeaderboardsGet200Response() *V2LeaderboardsGet200Response {
	this := V2LeaderboardsGet200Response{}
	return &this
}
...
// SetLeaderboards gets a reference to the given map[string]interface{} and assigns it to the Leaderboards field.
func (o *V2LeaderboardsGet200Response) SetLeaderboards(v map[string]interface{}) {
	o.Leaderboards = v
}

func (o V2LeaderboardsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o V2LeaderboardsGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableV2LeaderboardsGet200Response struct {
	value *V2LeaderboardsGet200Response
	isSet bool
}

func (v NullableV2LeaderboardsGet200Response) Get() *V2LeaderboardsGet200Response {
	return v.value
}

func (v *NullableV2LeaderboardsGet200Response) Set(val *V2LeaderboardsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2LeaderboardsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2LeaderboardsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2LeaderboardsGet200Response(val *V2LeaderboardsGet200Response) *NullableV2LeaderboardsGet200Response {
	return &NullableV2LeaderboardsGet200Response{value: val, isSet: true}
}

func (v NullableV2LeaderboardsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2LeaderboardsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
