...
// checks if the HousingHouseCookies type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HousingHouseCookies{}

// HousingHouseCookies struct for HousingHouseCookies
type HousingHouseCookies struct {
...
func (o HousingHouseCookies) MarshalJSON() ([]byte, error) {
...
func (o HousingHouseCookies) ToMap() (map[string]interface{}, error) {
...
type NullableHousingHouseCookies struct {
	value *HousingHouseCookies
	isSet bool
}

func (v NullableHousingHouseCookies) Get() *HousingHouseCookies {
	return v.value
}

func (v *NullableHousingHouseCookies) Set(val *HousingHouseCookies) {
	v.value = val
	v.isSet = true
}

func (v NullableHousingHouseCookies) IsSet() bool {
	return v.isSet
}

func (v *NullableHousingHouseCookies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHousingHouseCookies(val *HousingHouseCookies) *NullableHousingHouseCookies {
	return &NullableHousingHouseCookies{value: val, isSet: true}
}

func (v NullableHousingHouseCookies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHousingHouseCookies) UnmarshalJSON(src []byte) error {
	v.isSet = true
