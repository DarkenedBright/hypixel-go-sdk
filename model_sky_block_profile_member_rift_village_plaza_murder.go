...
type SkyBlockProfileMemberRiftVillagePlazaMurder struct {
	...
	StepIndexPt2 *float32 `json:"step_index_pt2,omitempty"`
	StepIndexPt3 *float32 `json:"step_index_pt3,omitempty"`
}
...
// SetStepIndexPt2 gets a reference to the given float32 and assigns it to the StepIndexPt2 field.
...
// SetStepIndexPt3 gets a reference to the given float32 and assigns it to the StepIndexPt3 field.
