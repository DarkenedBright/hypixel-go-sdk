...
// checks if the V2PlayerGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2PlayerGet200Response{}

// V2PlayerGet200Response struct for V2PlayerGet200Response
type V2PlayerGet200Response struct {
	Success *bool `json:"success,omitempty"`
	Player *V2PlayerGet200ResponsePlayer `json:"player,omitempty"`
}
...
func (o *V2PlayerGet200Response) GetPlayer() V2PlayerGet200ResponsePlayer {
	if o == nil || IsNil(o.Player) {
		var ret V2PlayerGet200ResponsePlayer
		return ret
	}
	return *o.Player
}
...
// SetPlayer gets a reference to the given V2PlayerGet200ResponsePlayer and assigns it to the Player field.
func (o *V2PlayerGet200Response) SetPlayer(v V2PlayerGet200ResponsePlayer) {
	o.Player = &v
}

func (o V2PlayerGet200Response) MarshalJSON() ([]byte, error) {
...
func (o V2PlayerGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableV2PlayerGet200Response struct {
	value *V2PlayerGet200Response
	isSet bool
}

func (v NullableV2PlayerGet200Response) Get() *V2PlayerGet200Response {
	return v.value
}

func (v *NullableV2PlayerGet200Response) Set(val *V2PlayerGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2PlayerGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2PlayerGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2PlayerGet200Response(val *V2PlayerGet200Response) *NullableV2PlayerGet200Response {
	return &NullableV2PlayerGet200Response{value: val, isSet: true}
}

func (v NullableV2PlayerGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2PlayerGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
