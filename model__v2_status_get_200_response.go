...
// checks if the V2StatusGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2StatusGet200Response{}

// V2StatusGet200Response struct for V2StatusGet200Response
type V2StatusGet200Response struct {
	Success *bool `json:"success,omitempty"`
	Uuid *string `json:"uuid,omitempty"`
	Session *V2StatusGet200ResponseSession `json:"session,omitempty"`
}
...
func (o *V2StatusGet200Response) GetSession() V2StatusGet200ResponseSession {
	if o == nil || IsNil(o.Session) {
		var ret V2StatusGet200ResponseSession
		return ret
	}
	return *o.Session
}
...
// SetSession gets a reference to the given V2StatusGet200ResponseSession and assigns it to the Session field.
func (o *V2StatusGet200Response) SetSession(v V2StatusGet200ResponseSession) {
	o.Session = &v
}

func (o V2StatusGet200Response) MarshalJSON() ([]byte, error) {
...
func (o V2StatusGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableV2StatusGet200Response struct {
	value *V2StatusGet200Response
	isSet bool
}

func (v NullableV2StatusGet200Response) Get() *V2StatusGet200Response {
	return v.value
}

func (v *NullableV2StatusGet200Response) Set(val *V2StatusGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2StatusGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2StatusGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2StatusGet200Response(val *V2StatusGet200Response) *NullableV2StatusGet200Response {
	return &NullableV2StatusGet200Response{value: val, isSet: true}
}

func (v NullableV2StatusGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2StatusGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
