...
// HousingAPIService HousingAPI service
type HousingAPIService service

type ApiV2HousingActiveGetRequest struct {
	ctx context.Context
	ApiService *HousingAPIService
}

func (r ApiV2HousingActiveGetRequest) Execute() ([]HousingHouse, *http.Response, error) {
	return r.ApiService.V2HousingActiveGetExecute(r)
}

/*
V2HousingActiveGet The currently active public houses.

This data may be cached for a short period of time.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiV2HousingActiveGetRequest
*/
func (a *HousingAPIService) V2HousingActiveGet(ctx context.Context) ApiV2HousingActiveGetRequest {
	return ApiV2HousingActiveGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return []HousingHouse
func (a *HousingAPIService) V2HousingActiveGetExecute(r ApiV2HousingActiveGetRequest) ([]HousingHouse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []HousingHouse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HousingAPIService.V2HousingActiveGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/housing/active"
...
type ApiV2HousingHouseGetRequest struct {
	ctx context.Context
	ApiService *HousingAPIService
	house *string
}

// The UUID of the house to get information about.
func (r ApiV2HousingHouseGetRequest) House(house string) ApiV2HousingHouseGetRequest {
	r.house = &house
	return r
}

func (r ApiV2HousingHouseGetRequest) Execute() (*HousingHouse, *http.Response, error) {
	return r.ApiService.V2HousingHouseGetExecute(r)
}

/*
V2HousingHouseGet Information about a specific house.

This data may be cached for a short period of time.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiV2HousingHouseGetRequest
*/
func (a *HousingAPIService) V2HousingHouseGet(ctx context.Context) ApiV2HousingHouseGetRequest {
	return ApiV2HousingHouseGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return HousingHouse
func (a *HousingAPIService) V2HousingHouseGetExecute(r ApiV2HousingHouseGetRequest) (*HousingHouse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HousingAPIService.V2HousingHouseGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/housing/house"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.house == nil {
		return localVarReturnValue, nil, reportError("house is required and must be specified")
	}

	parameterAddToHeaderOrQuery(localVarQueryParams, "house", r.house, "form", "")
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type ApiV2HousingHousesGetRequest struct {
	ctx context.Context
	ApiService *HousingAPIService
	player *string
}

// The UUID of the player to get houses for.
func (r ApiV2HousingHousesGetRequest) Player(player string) ApiV2HousingHousesGetRequest {
	r.player = &player
	return r
}

func (r ApiV2HousingHousesGetRequest) Execute() ([]HousingHouse, *http.Response, error) {
	return r.ApiService.V2HousingHousesGetExecute(r)
}

/*
V2HousingHousesGet The public houses for a specific player.

This data may be cached for a short period of time.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiV2HousingHousesGetRequest
*/
func (a *HousingAPIService) V2HousingHousesGet(ctx context.Context) ApiV2HousingHousesGetRequest {
	return ApiV2HousingHousesGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []HousingHouse
func (a *HousingAPIService) V2HousingHousesGetExecute(r ApiV2HousingHousesGetRequest) ([]HousingHouse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HousingAPIService.V2HousingHousesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/housing/houses"
