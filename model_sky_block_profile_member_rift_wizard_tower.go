...
type SkyBlockProfileMemberRiftWizardTower struct {
	CrumbsLaidOut *float32 `json:"crumbs_laid_out,omitempty"`
	WizardQuestStep *float32 `json:"wizard_quest_step,omitempty"`
}
...
// SetCrumbsLaidOut gets a reference to the given float32 and assigns it to the CrumbsLaidOut field.
...
// SetWizardQuestStep gets a reference to the given float32 and assigns it to the WizardQuestStep field.
