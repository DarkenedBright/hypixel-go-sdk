...
// checks if the V2CountsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2CountsGet200Response{}

// V2CountsGet200Response struct for V2CountsGet200Response
type V2CountsGet200Response struct {
...
func (o V2CountsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o V2CountsGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableV2CountsGet200Response struct {
	value *V2CountsGet200Response
	isSet bool
}

func (v NullableV2CountsGet200Response) Get() *V2CountsGet200Response {
	return v.value
}

func (v *NullableV2CountsGet200Response) Set(val *V2CountsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2CountsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2CountsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2CountsGet200Response(val *V2CountsGet200Response) *NullableV2CountsGet200Response {
	return &NullableV2CountsGet200Response{value: val, isSet: true}
}

func (v NullableV2CountsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2CountsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
