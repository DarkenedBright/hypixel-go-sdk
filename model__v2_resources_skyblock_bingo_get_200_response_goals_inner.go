...
type V2ResourcesSkyblockBingoGet200ResponseGoalsInner struct {
	...
	Tiers []float32 `json:"tiers,omitempty"`
	// The global progress of this goal
	Progress *float32 `json:"progress,omitempty"`
	// The required amount for this specific goal
	RequiredAmount *float32 `json:"requiredAmount,omitempty"`
}
...
// SetTiers gets a reference to the given []float32 and assigns it to the Tiers field.
...
// SetRequiredAmount gets a reference to the given float32 and assigns it to the RequiredAmount field.
