# SkyBlockProfileMemberNetherIslandPlayerData
...
GetSelectedFactionOk returns a tuple with the SelectedFaction field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
