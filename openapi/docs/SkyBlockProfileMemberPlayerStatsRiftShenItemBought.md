# SkyBlockProfileMemberPlayerStatsRiftShenItemBought
...
SetFLEX_HELMET sets FLEX_HELMET field to given value.
...
SetPUNCHCARD_ARTIFACT sets PUNCHCARD_ARTIFACT field to given value.
