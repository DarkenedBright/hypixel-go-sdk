...
type SkyBlockProfileMemberRiftVillagePlazaMurder struct {
	MurderSnapshot *SkyBlockProfileMemberRiftVillagePlazaMurderMurderSnapshot  `json:"murder_snapshot,omitempty"`
	RoomClues      []SkyBlockProfileMemberRiftVillagePlazaMurderRoomCluesInner `json:"room_clues,omitempty"`
...
// GetMurderSnapshot returns the MurderSnapshot field value if set, zero value otherwise.
func (o *SkyBlockProfileMemberRiftVillagePlazaMurder) GetMurderSnapshot() SkyBlockProfileMemberRiftVillagePlazaMurderMurderSnapshot {
	if o == nil || IsNil(o.MurderSnapshot) {
		var ret SkyBlockProfileMemberRiftVillagePlazaMurderMurderSnapshot
		return ret
	}
	return *o.MurderSnapshot
}

// GetMurderSnapshotOk returns a tuple with the MurderSnapshot field value if set, nil otherwise
...
// SetMurderSnapshot gets a reference to the given SkyBlockProfileMemberRiftVillagePlazaMurderMurderSnapshot and assigns it to the MurderSnapshot field.
...
func (o *SkyBlockProfileMemberRiftVillagePlazaMurder) GetRoomClues() []SkyBlockProfileMemberRiftVillagePlazaMurderRoomCluesInner {
	if o == nil || IsNil(o.RoomClues) {
		var ret []SkyBlockProfileMemberRiftVillagePlazaMurderRoomCluesInner
		return ret
	}
	return o.RoomClues
}
...
// SetRoomClues gets a reference to the given []SkyBlockProfileMemberRiftVillagePlazaMurderRoomCluesInner and assigns it to the RoomClues field.
...
func (o SkyBlockProfileMemberRiftVillagePlazaMurder) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MurderSnapshot) {
		toSerialize["murder_snapshot"] = o.MurderSnapshot
	}
