...
type ApiV2SkyblockAuctionsEndedGetRequest struct {
	ctx        context.Context
	ApiService *SkyBlockAPIService
}

func (r ApiV2SkyblockAuctionsEndedGetRequest) Execute() (*SkyBlockAuctionsEnded, *http.Response, error) {
	return r.ApiService.V2SkyblockAuctionsEndedGetExecute(r)
}

/*
V2SkyblockAuctionsEndedGet Recently ended auctions

SkyBlock auctions which ended in the last 60 seconds.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiV2SkyblockAuctionsEndedGetRequest
*/
func (a *SkyBlockAPIService) V2SkyblockAuctionsEndedGet(ctx context.Context) ApiV2SkyblockAuctionsEndedGetRequest {
	return ApiV2SkyblockAuctionsEndedGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return SkyBlockAuctionsEnded
func (a *SkyBlockAPIService) V2SkyblockAuctionsEndedGetExecute(r ApiV2SkyblockAuctionsEndedGetRequest) (*SkyBlockAuctionsEnded, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SkyBlockAuctionsEnded
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SkyBlockAPIService.V2SkyblockAuctionsEndedGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/skyblock/auctions_ended"
...
type ApiV2SkyblockBazaarGetRequest struct {
	ctx        context.Context
	ApiService *SkyBlockAPIService
}

func (r ApiV2SkyblockBazaarGetRequest) Execute() (*SkyBlockBazaar, *http.Response, error) {
	return r.ApiService.V2SkyblockBazaarGetExecute(r)
}

/*
V2SkyblockBazaarGet Bazaar

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiV2SkyblockBazaarGetRequest
*/
func (a *SkyBlockAPIService) V2SkyblockBazaarGet(ctx context.Context) ApiV2SkyblockBazaarGetRequest {
	return ApiV2SkyblockBazaarGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return SkyBlockBazaar
func (a *SkyBlockAPIService) V2SkyblockBazaarGetExecute(r ApiV2SkyblockBazaarGetRequest) (*SkyBlockBazaar, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SkyBlockBazaar
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SkyBlockAPIService.V2SkyblockBazaarGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/skyblock/bazaar"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 503 {
			var v V2SkyblockBazaarGet503Response
...
func (r ApiV2SkyblockBingoGetRequest) Execute() (*SkyBlockBingo, *http.Response, error) {
...
// Execute executes the request
//
//	@return SkyBlockBingo
func (a *SkyBlockAPIService) V2SkyblockBingoGetExecute(r ApiV2SkyblockBingoGetRequest) (*SkyBlockBingo, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SkyBlockBingo
	)
...
func (r ApiV2SkyblockFiresalesGetRequest) Execute() (*SkyBlockFireSales, *http.Response, error) {
...
// Execute executes the request
//
//	@return SkyBlockFireSales
func (a *SkyBlockAPIService) V2SkyblockFiresalesGetExecute(r ApiV2SkyblockFiresalesGetRequest) (*SkyBlockFireSales, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SkyBlockFireSales
	)
...
func (r ApiV2SkyblockGardenGetRequest) Execute() (*SkyBlockGardenGet, *http.Response, error) {
...
// Execute executes the request
//
//	@return SkyBlockGardenGet
func (a *SkyBlockAPIService) V2SkyblockGardenGetExecute(r ApiV2SkyblockGardenGetRequest) (*SkyBlockGardenGet, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SkyBlockGardenGet
	)
...
func (r ApiV2SkyblockMuseumGetRequest) Execute() (*SkyBlockMuseum, *http.Response, error) {
...
// Execute executes the request
//
//	@return SkyBlockMuseum
func (a *SkyBlockAPIService) V2SkyblockMuseumGetExecute(r ApiV2SkyblockMuseumGetRequest) (*SkyBlockMuseum, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SkyBlockMuseum
	)
...
func (r ApiV2SkyblockNewsGetRequest) Execute() (*SkyBlockNews, *http.Response, error) {
	return r.ApiService.V2SkyblockNewsGetExecute(r)
}

/*
V2SkyblockNewsGet Method for V2SkyblockNewsGet
...
//
//	@return SkyBlockNews
func (a *SkyBlockAPIService) V2SkyblockNewsGetExecute(r ApiV2SkyblockNewsGetRequest) (*SkyBlockNews, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SkyBlockNews
	)
