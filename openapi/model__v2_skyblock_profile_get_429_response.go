...
// checks if the V2SkyblockProfileGet429Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2SkyblockProfileGet429Response{}

// V2SkyblockProfileGet429Response struct for V2SkyblockProfileGet429Response
type V2SkyblockProfileGet429Response struct {
...
func NewV2SkyblockProfileGet429Response() *V2SkyblockProfileGet429Response {
	this := V2SkyblockProfileGet429Response{}
	return &this
}
...
func (o V2SkyblockProfileGet429Response) MarshalJSON() ([]byte, error) {
...
func (o V2SkyblockProfileGet429Response) ToMap() (map[string]interface{}, error) {
...
type NullableV2SkyblockProfileGet429Response struct {
	value *V2SkyblockProfileGet429Response
	isSet bool
}

func (v NullableV2SkyblockProfileGet429Response) Get() *V2SkyblockProfileGet429Response {
	return v.value
}

func (v *NullableV2SkyblockProfileGet429Response) Set(val *V2SkyblockProfileGet429Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2SkyblockProfileGet429Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2SkyblockProfileGet429Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2SkyblockProfileGet429Response(val *V2SkyblockProfileGet429Response) *NullableV2SkyblockProfileGet429Response {
	return &NullableV2SkyblockProfileGet429Response{value: val, isSet: true}
}

func (v NullableV2SkyblockProfileGet429Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2SkyblockProfileGet429Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
