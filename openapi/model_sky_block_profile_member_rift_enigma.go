...
type SkyBlockProfileMemberRiftEnigma struct {
	...
	FoundSouls        []SkyBlockProfileMemberRiftEnigmaFoundSoulsInner `json:"found_souls,omitempty"`
}
...
func (o *SkyBlockProfileMemberRiftEnigma) GetFoundSouls() []SkyBlockProfileMemberRiftEnigmaFoundSoulsInner {
	if o == nil || IsNil(o.FoundSouls) {
		var ret []SkyBlockProfileMemberRiftEnigmaFoundSoulsInner
		return ret
	}
	return o.FoundSouls
}
...
// SetFoundSouls gets a reference to the given []SkyBlockProfileMemberRiftEnigmaFoundSoulsInner and assigns it to the FoundSouls field.
