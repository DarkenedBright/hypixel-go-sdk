...
// checks if the SkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned{}

// SkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned struct for SkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned
type SkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned struct {
...
func NewSkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned() *SkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned {
	this := SkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned{}
	return &this
}
...
func (o *SkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned) SetTotal(v float64) {
	o.Total = &v
}
...
func (o SkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned) MarshalJSON() ([]byte, error) {
...
func (o SkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned) ToMap() (map[string]interface{}, error) {
...
type NullableSkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned struct {
	value *SkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned
	isSet bool
}

func (v NullableSkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned) Get() *SkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned {
	return v.value
}

func (v *NullableSkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned) Set(val *SkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned) {
	v.value = val
	v.isSet = true
}

func (v NullableSkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned) IsSet() bool {
	return v.isSet
}

func (v *NullableSkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned(val *SkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned) *NullableSkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned {
	return &NullableSkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned{value: val, isSet: true}
}

func (v NullableSkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSkyBlockProfileMemberPlayerStatsEndIslandDragonFightAmountSummoned) UnmarshalJSON(src []byte) error {
	v.isSet = true
