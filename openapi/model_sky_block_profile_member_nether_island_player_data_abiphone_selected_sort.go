...
const (
	SKYBLOCKPROFILEMEMBERNETHERISLANDPLAYERDATAABIPHONESELECTEDSORT_ALPHABETICAL SkyBlockProfileMemberNetherIslandPlayerDataAbiphoneSelectedSort = "alphabetical"
	SKYBLOCKPROFILEMEMBERNETHERISLANDPLAYERDATAABIPHONESELECTEDSORT_DND_ENABLED  SkyBlockProfileMemberNetherIslandPlayerDataAbiphoneSelectedSort = "dnd_enabled"
	SKYBLOCKPROFILEMEMBERNETHERISLANDPLAYERDATAABIPHONESELECTEDSORT_FIRST_ADDED  SkyBlockProfileMemberNetherIslandPlayerDataAbiphoneSelectedSort = "first_added"
	SKYBLOCKPROFILEMEMBERNETHERISLANDPLAYERDATAABIPHONESELECTEDSORT_LAST_CALLED  SkyBlockProfileMemberNetherIslandPlayerDataAbiphoneSelectedSort = "last_called"
