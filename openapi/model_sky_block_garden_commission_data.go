...
type SkyBlockGardenCommissionData struct {
	Completed        *SkyBlockGardenCommissionDataVisitorData `json:"completed,omitempty"`
	TotalCompleted   *int64                                   `json:"total_completed,omitempty"`
	UniqueNpcsServed *int64                                   `json:"unique_npcs_served,omitempty"`
	Visits           *SkyBlockGardenCommissionDataVisitorData `json:"visits,omitempty"`
}
...
func (o *SkyBlockGardenCommissionData) GetCompleted() SkyBlockGardenCommissionDataVisitorData {
	if o == nil || IsNil(o.Completed) {
		var ret SkyBlockGardenCommissionDataVisitorData
		return ret
	}
	return *o.Completed
}
...
// SetCompleted gets a reference to the given SkyBlockGardenCommissionDataVisitorData and assigns it to the Completed field.
...
// SetVisits gets a reference to the given SkyBlockGardenCommissionDataVisitorData and assigns it to the Visits field.
