...
// checks if the V2RecentgamesGet422Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2RecentgamesGet422Response{}

// V2RecentgamesGet422Response struct for V2RecentgamesGet422Response
type V2RecentgamesGet422Response struct {
...
func NewV2RecentgamesGet422Response() *V2RecentgamesGet422Response {
	this := V2RecentgamesGet422Response{}
	return &this
}
...
func (o V2RecentgamesGet422Response) MarshalJSON() ([]byte, error) {
...
func (o V2RecentgamesGet422Response) ToMap() (map[string]interface{}, error) {
...
type NullableV2RecentgamesGet422Response struct {
	value *V2RecentgamesGet422Response
	isSet bool
}

func (v NullableV2RecentgamesGet422Response) Get() *V2RecentgamesGet422Response {
	return v.value
}

func (v *NullableV2RecentgamesGet422Response) Set(val *V2RecentgamesGet422Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2RecentgamesGet422Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2RecentgamesGet422Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2RecentgamesGet422Response(val *V2RecentgamesGet422Response) *NullableV2RecentgamesGet422Response {
	return &NullableV2RecentgamesGet422Response{value: val, isSet: true}
}

func (v NullableV2RecentgamesGet422Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2RecentgamesGet422Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
