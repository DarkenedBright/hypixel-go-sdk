...
// checks if the SkyBlockProfileMembersProfileDeletionNotice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SkyBlockProfileMembersProfileDeletionNotice{}

// SkyBlockProfileMembersProfileDeletionNotice If this field exists, the member profile is marked as deleted
type SkyBlockProfileMembersProfileDeletionNotice struct {
...
func NewSkyBlockProfileMembersProfileDeletionNotice() *SkyBlockProfileMembersProfileDeletionNotice {
	this := SkyBlockProfileMembersProfileDeletionNotice{}
	return &this
}
...
func (o SkyBlockProfileMembersProfileDeletionNotice) MarshalJSON() ([]byte, error) {
...
func (o SkyBlockProfileMembersProfileDeletionNotice) ToMap() (map[string]interface{}, error) {
...
type NullableSkyBlockProfileMembersProfileDeletionNotice struct {
	value *SkyBlockProfileMembersProfileDeletionNotice
	isSet bool
}

func (v NullableSkyBlockProfileMembersProfileDeletionNotice) Get() *SkyBlockProfileMembersProfileDeletionNotice {
	return v.value
}

func (v *NullableSkyBlockProfileMembersProfileDeletionNotice) Set(val *SkyBlockProfileMembersProfileDeletionNotice) {
	v.value = val
	v.isSet = true
}

func (v NullableSkyBlockProfileMembersProfileDeletionNotice) IsSet() bool {
	return v.isSet
}

func (v *NullableSkyBlockProfileMembersProfileDeletionNotice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSkyBlockProfileMembersProfileDeletionNotice(val *SkyBlockProfileMembersProfileDeletionNotice) *NullableSkyBlockProfileMembersProfileDeletionNotice {
	return &NullableSkyBlockProfileMembersProfileDeletionNotice{value: val, isSet: true}
}

func (v NullableSkyBlockProfileMembersProfileDeletionNotice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSkyBlockProfileMembersProfileDeletionNotice) UnmarshalJSON(src []byte) error {
	v.isSet = true
