...
type SkyBlockProfileMemberRiftEnigma struct {
	...
	ClaimedBonusIndex *float32 `json:"claimed_bonus_index,omitempty"`
...
// SetClaimedBonusIndex gets a reference to the given float32 and assigns it to the ClaimedBonusIndex field.
