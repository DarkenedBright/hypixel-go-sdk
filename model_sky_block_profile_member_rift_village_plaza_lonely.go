...
type SkyBlockProfileMemberRiftVillagePlazaLonely struct {
	SecondsSitting *float32 `json:"seconds_sitting,omitempty"`
}
...
// SetSecondsSitting gets a reference to the given float32 and assigns it to the SecondsSitting field.
