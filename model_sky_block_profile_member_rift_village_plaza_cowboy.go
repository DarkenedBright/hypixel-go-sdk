...
type SkyBlockProfileMemberRiftVillagePlazaCowboy struct {
	HayEaten *float32 `json:"hay_eaten,omitempty"`
...
// SetHayEaten gets a reference to the given float32 and assigns it to the HayEaten field.
...
// SetStage gets a reference to the given float32 and assigns it to the Stage field.
