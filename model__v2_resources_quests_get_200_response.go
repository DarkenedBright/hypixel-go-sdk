...
// checks if the V2ResourcesQuestsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2ResourcesQuestsGet200Response{}

// V2ResourcesQuestsGet200Response struct for V2ResourcesQuestsGet200Response
type V2ResourcesQuestsGet200Response struct {
	Success *bool `json:"success,omitempty"`
	LastUpdated *float32 `json:"lastUpdated,omitempty"`
	Quests map[string]interface{} `json:"quests,omitempty"`
}
...
func NewV2ResourcesQuestsGet200Response() *V2ResourcesQuestsGet200Response {
	this := V2ResourcesQuestsGet200Response{}
	return &this
}
...
// SetQuests gets a reference to the given map[string]interface{} and assigns it to the Quests field.
func (o *V2ResourcesQuestsGet200Response) SetQuests(v map[string]interface{}) {
	o.Quests = v
}

func (o V2ResourcesQuestsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o V2ResourcesQuestsGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableV2ResourcesQuestsGet200Response struct {
	value *V2ResourcesQuestsGet200Response
	isSet bool
}

func (v NullableV2ResourcesQuestsGet200Response) Get() *V2ResourcesQuestsGet200Response {
	return v.value
}

func (v *NullableV2ResourcesQuestsGet200Response) Set(val *V2ResourcesQuestsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2ResourcesQuestsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2ResourcesQuestsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2ResourcesQuestsGet200Response(val *V2ResourcesQuestsGet200Response) *NullableV2ResourcesQuestsGet200Response {
	return &NullableV2ResourcesQuestsGet200Response{value: val, isSet: true}
}

func (v NullableV2ResourcesQuestsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2ResourcesQuestsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
