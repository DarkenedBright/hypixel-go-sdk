...
// checks if the V2ResourcesAchievementsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2ResourcesAchievementsGet200Response{}

// V2ResourcesAchievementsGet200Response struct for V2ResourcesAchievementsGet200Response
type V2ResourcesAchievementsGet200Response struct {
	Success *bool `json:"success,omitempty"`
	LastUpdated *float32 `json:"lastUpdated,omitempty"`
	Achievements map[string]interface{} `json:"achievements,omitempty"`
}
...
func NewV2ResourcesAchievementsGet200Response() *V2ResourcesAchievementsGet200Response {
	this := V2ResourcesAchievementsGet200Response{}
	return &this
}
...
// SetAchievements gets a reference to the given map[string]interface{} and assigns it to the Achievements field.
func (o *V2ResourcesAchievementsGet200Response) SetAchievements(v map[string]interface{}) {
	o.Achievements = v
}

func (o V2ResourcesAchievementsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o V2ResourcesAchievementsGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableV2ResourcesAchievementsGet200Response struct {
	value *V2ResourcesAchievementsGet200Response
	isSet bool
}

func (v NullableV2ResourcesAchievementsGet200Response) Get() *V2ResourcesAchievementsGet200Response {
	return v.value
}

func (v *NullableV2ResourcesAchievementsGet200Response) Set(val *V2ResourcesAchievementsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2ResourcesAchievementsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2ResourcesAchievementsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2ResourcesAchievementsGet200Response(val *V2ResourcesAchievementsGet200Response) *NullableV2ResourcesAchievementsGet200Response {
	return &NullableV2ResourcesAchievementsGet200Response{value: val, isSet: true}
}

func (v NullableV2ResourcesAchievementsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2ResourcesAchievementsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
