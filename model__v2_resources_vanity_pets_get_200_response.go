...
// checks if the V2ResourcesVanityPetsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2ResourcesVanityPetsGet200Response{}

// V2ResourcesVanityPetsGet200Response struct for V2ResourcesVanityPetsGet200Response
type V2ResourcesVanityPetsGet200Response struct {
	Success *bool `json:"success,omitempty"`
	LastUpdated *float32 `json:"lastUpdated,omitempty"`
	Types map[string]interface{} `json:"types,omitempty"`
	Rarities map[string]interface{} `json:"rarities,omitempty"`
}
...
func NewV2ResourcesVanityPetsGet200Response() *V2ResourcesVanityPetsGet200Response {
	this := V2ResourcesVanityPetsGet200Response{}
	return &this
}
...
// GetRarities returns the Rarities field value if set, zero value otherwise.
func (o *V2ResourcesVanityPetsGet200Response) GetRarities() map[string]interface{} {
	if o == nil || IsNil(o.Rarities) {
		var ret map[string]interface{}
		return ret
	}
	return o.Rarities
...
// GetRaritiesOk returns a tuple with the Rarities field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetRarities gets a reference to the given map[string]interface{} and assigns it to the Rarities field.
func (o *V2ResourcesVanityPetsGet200Response) SetRarities(v map[string]interface{}) {
	o.Rarities = v
}

func (o V2ResourcesVanityPetsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o V2ResourcesVanityPetsGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableV2ResourcesVanityPetsGet200Response struct {
	value *V2ResourcesVanityPetsGet200Response
	isSet bool
}

func (v NullableV2ResourcesVanityPetsGet200Response) Get() *V2ResourcesVanityPetsGet200Response {
	return v.value
}

func (v *NullableV2ResourcesVanityPetsGet200Response) Set(val *V2ResourcesVanityPetsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2ResourcesVanityPetsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2ResourcesVanityPetsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2ResourcesVanityPetsGet200Response(val *V2ResourcesVanityPetsGet200Response) *NullableV2ResourcesVanityPetsGet200Response {
	return &NullableV2ResourcesVanityPetsGet200Response{value: val, isSet: true}
}

func (v NullableV2ResourcesVanityPetsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2ResourcesVanityPetsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
