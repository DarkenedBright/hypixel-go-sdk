...
// checks if the V2ResourcesGuildsAchievementsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2ResourcesGuildsAchievementsGet200Response{}

// V2ResourcesGuildsAchievementsGet200Response struct for V2ResourcesGuildsAchievementsGet200Response
type V2ResourcesGuildsAchievementsGet200Response struct {
	Success *bool `json:"success,omitempty"`
	LastUpdated *float32 `json:"lastUpdated,omitempty"`
	OneTime map[string]interface{} `json:"one_time,omitempty"`
	Tiered map[string]interface{} `json:"tiered,omitempty"`
}
...
func NewV2ResourcesGuildsAchievementsGet200Response() *V2ResourcesGuildsAchievementsGet200Response {
	this := V2ResourcesGuildsAchievementsGet200Response{}
	return &this
}
...
// SetOneTime gets a reference to the given map[string]interface{} and assigns it to the OneTime field.
...
// SetTiered gets a reference to the given map[string]interface{} and assigns it to the Tiered field.
func (o *V2ResourcesGuildsAchievementsGet200Response) SetTiered(v map[string]interface{}) {
	o.Tiered = v
}

func (o V2ResourcesGuildsAchievementsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o V2ResourcesGuildsAchievementsGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableV2ResourcesGuildsAchievementsGet200Response struct {
	value *V2ResourcesGuildsAchievementsGet200Response
	isSet bool
}

func (v NullableV2ResourcesGuildsAchievementsGet200Response) Get() *V2ResourcesGuildsAchievementsGet200Response {
	return v.value
}

func (v *NullableV2ResourcesGuildsAchievementsGet200Response) Set(val *V2ResourcesGuildsAchievementsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2ResourcesGuildsAchievementsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2ResourcesGuildsAchievementsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2ResourcesGuildsAchievementsGet200Response(val *V2ResourcesGuildsAchievementsGet200Response) *NullableV2ResourcesGuildsAchievementsGet200Response {
	return &NullableV2ResourcesGuildsAchievementsGet200Response{value: val, isSet: true}
}

func (v NullableV2ResourcesGuildsAchievementsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2ResourcesGuildsAchievementsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
