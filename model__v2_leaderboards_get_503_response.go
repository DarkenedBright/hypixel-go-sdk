...
// checks if the V2LeaderboardsGet503Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2LeaderboardsGet503Response{}

// V2LeaderboardsGet503Response struct for V2LeaderboardsGet503Response
type V2LeaderboardsGet503Response struct {
...
func NewV2LeaderboardsGet503Response() *V2LeaderboardsGet503Response {
	this := V2LeaderboardsGet503Response{}
	return &this
}
...
func (o V2LeaderboardsGet503Response) MarshalJSON() ([]byte, error) {
...
func (o V2LeaderboardsGet503Response) ToMap() (map[string]interface{}, error) {
...
type NullableV2LeaderboardsGet503Response struct {
	value *V2LeaderboardsGet503Response
	isSet bool
}

func (v NullableV2LeaderboardsGet503Response) Get() *V2LeaderboardsGet503Response {
	return v.value
}

func (v *NullableV2LeaderboardsGet503Response) Set(val *V2LeaderboardsGet503Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2LeaderboardsGet503Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2LeaderboardsGet503Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2LeaderboardsGet503Response(val *V2LeaderboardsGet503Response) *NullableV2LeaderboardsGet503Response {
	return &NullableV2LeaderboardsGet503Response{value: val, isSet: true}
}

func (v NullableV2LeaderboardsGet503Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2LeaderboardsGet503Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
